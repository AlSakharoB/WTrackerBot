...
Из дополнения Telegram Mini App реализованы этапы M1-M6:
...
В Mini App доступны профиль, рацион и учет веса. Раздел веса использует общие
с ботом записи и цели, поддерживает CRUD измерений, диапазоны до 365 дней,
7-дневное скользящее среднее и интерактивный график Recharts.
